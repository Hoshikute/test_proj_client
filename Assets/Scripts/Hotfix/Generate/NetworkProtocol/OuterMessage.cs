...
namespace Fantasy
{
	...
	[ProtoContract]
	public partial class RegistAccountRequest : AMessage, IRequest, IProto
	{
		public static RegistAccountRequest Create(Scene scene)
		{
			return scene.MessagePoolComponent.Rent<RegistAccountRequest>();
		}
		public override void Dispose()
		{
			account = default;
			passward = default;
#if FANTASY_NET || FANTASY_UNITY
			GetScene().MessagePoolComponent.Return<RegistAccountRequest>(this);
#endif
		}
		[ProtoIgnore]
		public RegistAccountResponse ResponseType { get; set; }
		public uint OpCode() { return OuterOpcode.RegistAccountRequest; }
		[ProtoMember(1)]
	...
	[ProtoContract]
	public partial class RegistAccountResponse : AMessage, IResponse, IProto
	{
		public static RegistAccountResponse Create(Scene scene)
		{
			return scene.MessagePoolComponent.Rent<RegistAccountResponse>();
		}
		public override void Dispose()
		{
			ErrorCode = default;
			...
			passward = default;
#if FANTASY_NET || FANTASY_UNITY
			GetScene().MessagePoolComponent.Return<RegistAccountResponse>(this);
#endif
		}
		public uint OpCode() { return OuterOpcode.RegistAccountResponse; }
		[ProtoMember(1)]
		public string account { get; set; }
		[ProtoMember(2)]
		public string passward { get; set; }
